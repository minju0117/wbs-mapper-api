...
| 업무 | task | subTask | startDate | duration | owner |
|------|------|---------|-----------|----------|-------|
| 착수 | 기획 | 킥오프 | D0 | 1 | {고객사명}/더위버 |
| 착수 | 기획 | 구축방향/요구사항정의 | D0 | 4~9 | {고객사명}/더위버 |
| 착수 | 기획 | WBS수립 | D0+1 | 4~8 | 더위버 |
| 착수 | 기획 | IA설계 | D0+1 | 6~10 | 더위버 |  ← WBS수립과 병행, WBS보다 2~4일 늦게 끝남

IA_END = D0+1 + (IA설계 기간) - 1  ← 이후 모든 Front 화면설계의 기준점

| 착수 | 기획 | 콘텐츠 수급 - {메뉴명} | D0+1 | 10~20 | {고객사명} | ← 메뉴마다 1행씩, 반드시 전체 메뉴 포함
| 착수 | 개발 | 서버 환경 확인 및 설정 협의 | IA_END | 4~10 | {고객사명}/더위버 |
| 착수 | 개발 | 내부 개발 환경 세팅 | 서버협의 완료 후 | 4~8 | 더위버 |
